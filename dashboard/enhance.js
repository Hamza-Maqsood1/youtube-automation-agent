/* ============================================================
   YT Agent enhancement layer — motion, command palette,
...
(() => {
  ...
  const MINI_LABELS = {
    ...
    calendar: 'Calendar', analytics: 'Stats', engagement: 'Engagement', readiness: 'Checks', settings: 'Setup'
  };
  ...
  const VIEW_META = {
    ...
    operator: ['AUTONOMOUS OPERATOR', 'Configure your channel strategy.', 'Operator'],
    ...
    engagement: ['AUDIENCE ENGAGEMENT', 'Talk with the people watching.', 'Engagement'],
  ...
  if (typeof baseSwitchView === 'function') {
    window.switchView = function (view) {
      ...
      currentView = view;
      baseSwitchView(view);
      document.title = `${VIEW_META[view][2]} · YT Agent`;
  ...
  palette.innerHTML = `
    <div class="cmdk" role="dialog" aria-modal="true" aria-label="Command palette">
      ...
      <div class="cmdk-foot"><span><kbd>↑</kbd><kbd>↓</kbd> navigate</span><span><kbd>↵</kbd> run</span><span class="cmdk-brand">YT Agent</span></div>
    </div>`;
